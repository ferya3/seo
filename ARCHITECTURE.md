...
| Orchestrator (`agents/orchestrator`) | ✅ کار می‌کند، ۶۹ تست روی Postgres واقعی | گردش‌کار سه‌مرحله‌ای + خلاصه‌ی اجرایی؛ حلقه‌ی کامل روی RabbitMQ و Postgres واقعی اجرا شد |
...
TEST_DATABASE_URL=postgresql://seo@127.0.0.1/seo pytest    # ۳۵۳ تست
```
